...
export function LevelProgressCard({
  ...
  return (
    <Card className="rounded-3xl bg-gradient-to-tr from-emerald-600 via-teal-600 to-emerald-700 text-white p-6 sm:p-8 border-none relative overflow-hidden shadow-xl shadow-emerald-500/10">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs font-semibold text-emerald-100">
            <span className="flex items-center gap-1">
              ...
              Total XP: {level.currentXp} XP
            </span>
            <span>Target Level Berikutnya: {level.nextLevelXp} XP</span>
          </div>
